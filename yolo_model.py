...
class Net(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.yolo1 = Yolo(in_channels=out_channels, out_channels=out_channels, mask=mask1)
        ...
        self.yolo2 = Yolo(in_channels=out_channels, out_channels=out_channels, mask=mask2)
        ...
        self.yolo3 = Yolo(in_channels=out_channels, out_channels=out_channels, mask=mask3)
